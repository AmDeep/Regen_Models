...
```{r}
#Read in data
heart_disease_dataset <- read.csv(file = "C:\\Users\\Amardeep\\Downloads\\egen20.csv", header = F)
...
```
```{r}
heart.data <- read.csv("C:\\Users\\Amardeep\\Downloads\\egen20.csv",header=FALSE,sep=",",na.strings = '?')
...
```
```{r}
dataset=read.csv(file = "C:\\Users\\Amardeep\\Downloads\\egen20.csv", sep = ",")
library(ggplot2)
...
```
```{r}
full<- read.csv('C:\\Users\\Amardeep\\Downloads\\egen20.csv', na = "?", stringsAsFactors = FALSE, header = FALSE)
